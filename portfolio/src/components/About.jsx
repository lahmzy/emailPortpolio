    ...
    <section className="w-full bg-white">
      ...
      <div className="flex flex-col md:flex-row w-full justify-evenly items-center hover:shadow-lg shadow-md py-5 px-4">
        <div className=" md:w-1/2 flex md:ml-10 py-10">
          <img
            className="h-80 w-80 border brightness-50 rounded-full object-cover"
            src="/img/please.png"
          />
        </div>
        <div className="flex flex-col gap-4 w-full md:w-1/2 py-10">
          ...
          <p className="text-base my-1 font-medium text-veryDarkBlue">whether you need a one off or series of content,email campaigns,<br/>i'm here to help.</p>
        </div>
      </div>
    </section>
  );
